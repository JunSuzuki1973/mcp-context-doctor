...
Local validation date: 2026-09-07 (0.2.0). Test data is synthetic. This is a scoped engineering record, not security certification.

- Windows / Python 3.11.15 and 3.14.4: unit and integration suite passes (66 tests), including legacy `2025-11-25` STDIO and current `2026-07-28` Streamable HTTP discovery.
